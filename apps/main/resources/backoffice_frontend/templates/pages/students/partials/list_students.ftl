<h3 class="font-sans text-gray-800 text-center text-3xl mb-10">Estudiantes existentes</h3>


<form action="" method="get" id="students-filters" name="filter-students">
    <div id="filter-rows">
...
<script>
        ...
        fetch(encodeURI(url))
            ...
            .then(function (students) {
                ...
                students.forEach(function (student) {
                    ...
                    studentRow.appendChild(tableCellFor(student.id));
                    studentRow.appendChild(tableCellFor(student.name));
                    studentRow.appendChild(tableCellFor(student.surname));
                    studentRow.appendChild(tableCellFor(student.email));
    ...
    function filterStudents(e) {
        ...
        const form = document.forms["filter-students"];
        ...
        const url = "http://localhost:8091/students?" + urlParts.join("&");
...
<script>
    addStudentsList("http://localhost:8091/students");
</script>
